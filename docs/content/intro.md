...
- **Why agents:** TODO <!-- TODO: one or two sentences in Nim's own words on how agents moved from a novelty to a daily tool for course design, writing, and analysis -->
...
**Next →** [Start the lecture](lecture.html)
